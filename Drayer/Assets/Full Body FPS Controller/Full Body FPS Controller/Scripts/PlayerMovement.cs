...
namespace EasySurvivalScripts
{
    ...
    public class PlayerMovement : MonoBehaviour
    {
        ...
        public bool walkingHorizAnimation;
        public bool walkingVertAnimation;
        ...
        void HandlePlayerControls()
        {
            ...
            if (characterController.isGrounded)
            {
                ...
                {
                    if (_speed == walkSpeed)
                        playerStates = PlayerStates.HorizontalWalking;
                    else
                ...
                {
                    if (_speed == walkSpeed)
                        playerStates = PlayerStates.VerticalWalking;
                    else
                        playerStates = PlayerStates.Running;
        ...
        void SetCharacterAnimations()
        {
            ...
            CharacterAnimator.SetBool("isHorizontalWalking", walkingHorizAnimation);
            CharacterAnimator.SetBool("isVerticalWalking", walkingVertAnimation);
        }
